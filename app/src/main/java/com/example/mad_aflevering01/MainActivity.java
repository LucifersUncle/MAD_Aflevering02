...
import com.example.mad_aflevering01.API.WeatherApi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        api = new WeatherApi(getApplicationContext());
        api.getWeatherAPIDate("Silkeborg", "038412d86cf875f1a0c691f14a109191");
        GetWeatherData();
